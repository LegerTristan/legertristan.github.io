...
Après avoir exploré les bases avec mon [précédent shader d'effet de scan](lien-vers-ton-post-precedent), j'ai décidé de m'attaquer à un pilier fondamental du Technical Art : **la manipulation des UVs**.
